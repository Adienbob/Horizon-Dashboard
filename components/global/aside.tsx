      ...
      <aside
         ...
         <div className="border-b border-(--main-bg)" id="header">
            <h2 className="py-7.5 text-[26px] font-medium text-center text-(--primary) ">
               <span className="font-black">HORIZON</span> FREE
            </h2>
         </div>
         <nav>
            <ul className={`mt-[38px] ml-[31px] space-y-2 gap-5 grid [&_li]:m-0 text-(--secondary) text-[16px] [&_li]:flex [&_li]:items-center [&_li]:gap-2`}>
               <li className={`${pathname === links[0].href ? "text-(--primary) font-bold [&_div]:text-(--primary-blue)" : ""}`}>
                  <div>
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                     <g clipPath="url(#clip0_201_2912)">
                     <path d="M10.0001 19V14H14.0001V19C14.0001 19.55 14.4501 20 15.0001 20H18.0001C18.5501 20 19.0001 19.55 19.0001 19V12H20.7001C21.1601 12 21.3801 11.43 21.0301 11.13L12.6701 3.59997C12.2901 3.25997 11.7101 3.25997 11.3301 3.59997L2.9701 11.13C2.6301 11.43 2.8401 12 3.3001 12H5.0001V19C5.0001 19.55 5.4501 20 6.0001 20H9.0001C9.5501 20 10.0001 19.55 10.0001 19Z" fill="currentColor"/>
                     </g>
                     <defs>
                  ...
                  <Link onClick={() => setIsOpen(false)} href={links[0].href}>
                     {links[0].name}
                  </Link>
               </li>
               <li className={`${pathname === links[1].href ? "text-(--primary) font-bold [&_div]:text-(--primary-blue)" : ""}`}>
                  ...
                  <Link onClick={() => setIsOpen(false)} href={links[1].href}>
                     {links[1].name}
                  </Link>
               </li>
               <li className={`${pathname === links[2].href ? "text-(--primary) font-bold [&_div]:text-(--primary-blue)" : ""}`}>
                  ...
                  <Link onClick={() => setIsOpen(false)} href={links[2].href}>
                     {links[2].name}
                  </Link>
               </li>
               <li className={`${pathname === links[3].href ? "text-(--primary) font-bold [&_div]:text-(--primary-blue)" : ""}`}>
                  ...
                  <Link onClick={() => setIsOpen(false)} href={links[3].href}>
                     {links[3].name}
                  </Link>
               </li>
               <li className={`${pathname === links[4].href ? "text-(--primary) font-bold [&_div]:text-(--primary-blue)" : ""}`}>
                  ...
                  <Link onClick={() => setIsOpen(false)} href={links[4].href}>
                     {links[4].name}
                  </Link>
               </li>
               <li className={`${pathname === links[5].href ? "text-(--primary) font-bold [&_div]:text-(--primary-blue)" : ""}`}>
                  <div>
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M18 8H17V6C17 3.24 14.76 1 12 1C9.24 1 7 3.24 7 6V8H6C4.9 8 4 8.9 4 10V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V10C20 8.9 19.1 8 18 8ZM12 17C10.9 17 10 16.1 10 15C10 13.9 10.9 13 12 13C13.1 13 14 13.9 14 15C14 16.1 13.1 17 12 17ZM9 8V6C9 4.34 10.34 3 12 3C13.66 3 15 4.34 15 6V8H9Z" fill="correntColor"/>
                        </g>
                        <defs>
                  ...
                  <Link onClick={() => setIsOpen(false)} href={links[5].href}>
                     {links[5].name}
                  </Link>
               </li>
            </ul>
