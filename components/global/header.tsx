...
export default function Header({isOpen, setIsOpen, pathName}: HeaderProps) {
   ...
   return (
      <header className={`${current?.path === "/sign" ? "hidden" : ""} sticky top-2 z-30 ${theme === "light" ? "bg-white/10" : "0b14374d"} p-2 md:p-3 backdrop-blur-xl rounded-xl md:col-span-full`}>
            ...
            <div className="flex items-center gap-5 justify-between bg-(--component-bg) px-2 py-[7.5px] rounded-[30px] md:gap-2 md:px-2 lg:gap-10 2xl:gap-5 2xl:w-[80%] 2xl:ml-auto">
               <div>
                  <label htmlFor="searchBar" className="bg-(--main-bg)  flex items-center px-4 py-3 rounded-[30px] w-fit">
                     ...
                     <circle cx="5" cy="5" r="4.3" stroke="var(--icon-color)" strokeWidth="1.4"/>
                     <line x1="10.0101" y1="11" x2="8" y2="8.98995" stroke="var(--icon-color)" strokeWidth="1.4" strokeLinecap="round"/>
                     </svg>
                     <input className="text-base placeholder:text-sm placeholder:text-(--icon-color)  placeholder:font-medium w-25 ml-2 text-(--extensions) md:w-30 lg:w-40" type="search" id="searchBar" placeholder="Search..." />
                  </label>
               </div>
               <ul className="flex items-center [&_li]:flex [&_li]:items-center w-full justify-between">
                  <li className=" 2xl:hidden">
                     <button aria-label="Toggle sidebar" aria-expanded={isOpen} aria-controls="sidebar" onClick={() => setIsOpen(!isOpen)}>
                           <svg stroke="var(--icon-color)" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1.25rem" width="1.25rem" xmlns="http://www.w3.org/2000/svg"><line x1="21" y1="10" x2="3" y2="10"></line><line x1="21" y1="6" x2="3" y2="6"></line><line x1="21" y1="14" x2="3" y2="14"></line><line x1="21" y1="18" x2="3" y2="18"></line></svg>
                     </button>
                  </li>
                  <li className="">
                  ...
                  <li className="">
                     <button aria-label={theme === "dark" ? "Switch to light theme" : "Switch to dark theme"} onClick={() => setTheme(prev => prev === "dark" ? "light" : "dark")} className="h-[18px]">
                        <svg className={theme === "light" ? "block" : "hidden"} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className={`${theme === "dark" ? "block" : "hidden"}`} width="18" height="18" stroke="currentColor" fill="var(--icon-color)" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 18C8.68629 18 6 15.3137 6 12C6 8.68629 8.68629 6 12 6C15.3137 6 18 8.68629 18 12C18 15.3137 15.3137 18 12 18ZM11 1H13V4H11V1ZM11 20H13V23H11V20ZM3.51472 4.92893L4.92893 3.51472L7.05025 5.63604L5.63604 7.05025L3.51472 4.92893ZM16.9497 18.364L18.364 16.9497L20.4853 19.0711L19.0711 20.4853L16.9497 18.364ZM19.0711 3.51472L20.4853 4.92893L18.364 7.05025L16.9497 5.63604L19.0711 3.51472ZM5.63604 16.9497L7.05025 18.364L4.92893 20.4853L3.51472 19.0711L5.63604 16.9497ZM23 11V13H20V11H23ZM4 11V13H1V11H4Z"></path></svg>
                     </button>
                  </li>
                  <li className="flex">
